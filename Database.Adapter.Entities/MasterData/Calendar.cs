...
[XmlRoot(ElementName = nameof(Calendar), IsNullable = false, Namespace = XmlNameSpaces.CALENDARDAY_NAMESPACE)]
public sealed class Calendar : IdentityModel
{
	...
	[JsonPropertyName(nameof(DayType))]
	[XmlElement(ElementName = nameof(DayType))]
	public EnDayType DayType { get; set; } = default!;
	#endregion
}
