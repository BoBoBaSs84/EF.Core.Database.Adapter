...
internal static class Endpoints
{
	...
	internal static class Account
	{
		...
		internal static class Transaction
		{
			...
			internal const string Get = "{accountId:guid}" + "/" + nameof(Transaction) + "/" + "{id:guid}";
			internal const string Post = "{accountId:guid}" + "/" + nameof(Transaction);
			internal const string Put = "{accountId:guid}" + "/" + nameof(Transaction) + "/" + "{id:guid}";
		}
	}
	...
	internal static class Card
	{
		...
		internal static class Transaction
		{
			...
			internal const string Get = "{cardId:guid}" + "/" + nameof(Transaction) + "/" + "{id:guid}";
			internal const string Post = "{cardId:guid}" + "/" + nameof(Transaction);
			internal const string Put = "{cardId:guid}" + "/" + nameof(Transaction) + "/" + "{id:guid}";
		}
	}
