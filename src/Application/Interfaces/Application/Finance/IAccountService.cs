...
public interface IAccountService
{
	...
	/// <param name="token">The cancellation token to cancel the request.</param>
	/// <returns><see cref="ErrorOr{TValue}"/></returns>
	Task<ErrorOr<Deleted>> Delete(Guid accountId, CancellationToken token = default);
	...
	Task<ErrorOr<AccountResponse>> GetByNumber(Guid userId, string iban, CancellationToken token = default);
