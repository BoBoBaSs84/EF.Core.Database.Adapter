...
public partial class InitialCreation : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.InsertData(
				...
				values: new object[,]
				{
										{ 1, "54f76b81-6c41-4e3c-8d1e-2f9dcf54cc42", "This is the ultimate god role ... so to say.", "Administrator", "ADMINISTRATOR" },
										{ 2, "5182d577-d6d4-441f-ba3f-287bfb0ababf", "This is a normal user with normal user rights.", "User", "USER" },
										{ 3, "9818c449-3bb2-45a1-bc50-63bc618e0e60", "The user with extended user rights.", "Super user", "SUPERUSER" }
				});
