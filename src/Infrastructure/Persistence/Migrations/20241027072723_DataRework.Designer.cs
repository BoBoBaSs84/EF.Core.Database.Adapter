...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241027072723_DataRework")]
    partial class DataRework
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Documents.DocumentData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("DocumentData", "documents");

                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("DocumentData", "history");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("Domain.Models.Identity.RoleModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e309a398-7674-4382-ab70-6ff6413bd0fb"),
                        ...
                        new
                        {
                            Id = new Guid("526ba02d-45d0-4a44-b028-e6e6e652d360"),
                        ...
                        new
                        {
                            Id = new Guid("07c8dac7-478c-45a4-8e02-ca46bd3f3838"),
