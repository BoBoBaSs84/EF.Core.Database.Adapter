...
internal sealed class DocumentDataRepository(IRepositoryContext repositoryContext) : IdentityRepository<DataEntity>(repositoryContext), IDocumentDataRepository
{ }
