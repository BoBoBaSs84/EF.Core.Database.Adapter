        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditedBy = table.Column<string>(type: "sysname", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("6955ff15-d38a-4571-82e1-2fe14077c435"), null, "This is a normal user with normal user rights.", "User", "User" },
                    { new Guid("9967dbf8-0c45-4f56-b416-66d93e988920"), null, "The user with extended user rights.", "Super user", "SuperUser" },
                    { new Guid("c7d8b23b-028c-42ba-adcb-a6040f4d6ec5"), null, "This is the ultimate god role ... so to say.", "Administrator", "Administrator" }
                });
