...
internal sealed class ListUserConfiguration : AuditedCompositeConfiguration<ListUser>
{
	public override void Configure(EntityTypeBuilder<ListUser> builder)
	{
		builder.ToHistoryTable(nameof(ListUser), SqlSchema.Todo, SqlSchema.History);
